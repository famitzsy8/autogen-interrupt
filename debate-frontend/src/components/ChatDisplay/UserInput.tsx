 ...
 * - Agent selection dropdown (debate participants only)
...
import { DEBATE_PARTICIPANTS, getAgentDisplayName } from '../../constants/agents'
  ...
  return (
    <div className="border-t border-dark-border p-4 bg-dark-bg">
      ...
      <div className="mt-2 text-xs text-gray-600">
        {isInterrupted
          ? 'Select an agent and type your message to continue the debate'
