...
def main():
    ...
    output_path = f"./congressMCP/analysis/ragExperiment/committee_meetings_{CONGRESS}_{CHAMBER}_{NUM_MEETINGS}.json"
...
if __name__ == "__main__":
    print(getNumMeetings(f"./congressMCP/analysis/ragExperiment/committee_meetings_{CONGRESS}_{CHAMBER}_{NUM_MEETINGS}.json"))
    print(getNumTokens(f"./congressMCP/analysis/ragExperiment/committee_meetings_{CONGRESS}_{CHAMBER}_{NUM_MEETINGS}.json"))