...
class MCPServerWrapper:
    ...
    def getCongressMemberState(self, bioguideIds: List[str]) -> dict:
        res = []
        for bioguideId in bioguideIds:
            result = getCongressMember(bioguideId)
            res.append({bioguideId: result["stateCode"].strip()})
        return {"states": res}
        
    def getCongressMemberParty(self, bioguideIds: List[str]) -> dict:
        res = []
        for bioguideId in bioguideIds:

            result = getCongressMember(bioguideId)
            res.append({bioguideId: result["party"]})
        return {"parties": res}
    ...
    def _debug_agent(self):
        print(self.getCongressMemberState(["L000573", "M000422", "J000293", "B001262", "C001098", "B001045", "G000582", "T000479", "E000296", "R000618", "J000191", "S001223", "N000306", "S001204"]))
